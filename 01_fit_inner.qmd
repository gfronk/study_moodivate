...
We define our statistical algorithm, "glmnet" (elastic net regression), and "ml_mode" (classification vs. regression). 

We define ranges for the two glmnet tuning parameters, alpha (mixture, `hp1`) and lambda (penalty, `hp2`). 
