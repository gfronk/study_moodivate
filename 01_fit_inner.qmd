...
```{r}
if (file.exists("~/Desktop/internship/moodivate/results.csv")) {
  results <- read_csv("~/Desktop/internship/moodivate/results.csv",
                      show_col_types = F)
} else {
...
```{r}
results |> 
  write_csv("~/Desktop/internship/moodivate/results.csv")
```
